...
function calculateAverages(data, callback) {
  ...
  console.log("-- 1SQUARE MINER: ", data.miner, " --");
  console.log(
    "---------------------------------------------------------------------"
  );
...
axios
  .get("https://1square.net/api/stats")
  .then((response) => {
...
function run(minersAddress) {
  ...
  axios
    .get("https://1square.net/api/worker_stats?" + minersAddress)
    .then((response) => {
      ...
      setTimeout(function () {
        calculateAverages(response.data, function (
          ...
          axios
            .get("https://1square.net/api/payments")
            .then((response) => {
              // console.log(response.data[0].pools.vidulum);
              determinePaidOut(
                response.data,
